...
const Dropzone = () => {
    ...
    const validateFile = (file) => {
        const validTypes = ['image/jpeg', 'image/jpg', 'image/png', 'image/gif', 'image/x-icon', 'aplication/geojson'];
                ...
                <table>
                    ...
                    <tbody>
                        <tr className="baris-waktu">
                            ...
                            <td>
                                <input type="time" className="form-control" name="from[]" id="from"/>
                            </td>
                            <td>
                                <input type="time" className="form-control" name="to[]" id="to"/>
                            </td>
                            <td>
                                <input type="button" className="remove-bt btn btn-danger" value="hapus"/>
                            </td>
                        </tr>
